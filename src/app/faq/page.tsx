      ...
      <section className="bg-gradient-to-br from-[#1B3A6B] to-[#2a5298] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/80 text-lg max-w-2xl">
            Encontre respostas para as dúvidas mais comuns sobre nossos cursos, matrícula e certificação.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-white rounded-xl shadow-md p-8 text-center">
            <h3 className="text-xl font-bold text-[#1B3A6B] mb-2">Ainda tem dúvidas?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="bg-[#F5A623] hover:bg-[#e0950e] text-white font-semibold px-6 py-3 rounded-lg transition-colors flex items-center justify-center gap-2"
              >
